...
public class TicTacToe_s extends javax.swing.JFrame {
    ...
    //method that will check if the player has completed a set
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jButton2.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jButton3.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jlblPlayerX.setFont(new java.awt.Font("Century Gothic", 1, 48)); // NOI18N
        ...
        jButton4.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jButton5.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jButton6.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jlblPlayerO.setFont(new java.awt.Font("Century Gothic", 1, 48)); // NOI18N
        ...
        jButton7.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jButton8.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jButton9.setFont(new java.awt.Font("Century Gothic", 1, 96)); // NOI18N
        ...
        jbtnReset.setFont(new java.awt.Font("Century Gothic", 1, 48)); // NOI18N
        ...
        jbtnExit.setFont(new java.awt.Font("Century Gothic", 1, 48)); // NOI18N
...
//Allows user to end the program whenever they want
...
// Allows user to restart the screen and replay the game
    private void jbtnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnResetActionPerformed
        ...
        jButton1.setBackground(Color.getHSBColor(240, 100, 100));
        jButton2.setBackground(Color.getHSBColor(240, 100, 100));
        jButton3.setBackground(Color.getHSBColor(240, 100, 100));
        
        jButton4.setBackground(Color.getHSBColor(240, 100, 100));
        jButton5.setBackground(Color.getHSBColor(240, 100, 100));
        jButton6.setBackground(Color.getHSBColor(240, 100, 100));
        
        jButton7.setBackground(Color.getHSBColor(240, 100, 100));
        jButton8.setBackground(Color.getHSBColor(240, 100, 100));
        jButton9.setBackground(Color.getHSBColor(240, 100, 100));
    }//GEN-LAST:event_jbtnResetActionPerformed
//The following buttons all control what happens when one of the nine play
//buttons is pressed
